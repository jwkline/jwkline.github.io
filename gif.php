<?php
	...
	$font = array(
		...
		'file' => '/fonts/OpenSans-Medium.ttc', // Font path
		'color' => imagecolorallocate($image, 75, 156, 211), // RGB Colour of the text
	);
	for($i = 0; $i <= 60; $i++){
		...
		if($future_date < $now){
			...
			imagettftext ($image , $font['size'] , $font['angle'] , $font['x-offset'] , $font['y-offset'] , $font['color'] , $font['/fonts/OpenSans-Medium.ttc'], $text );
			ob_start();
			imagegif($image);
